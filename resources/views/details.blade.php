                    ...
                    <div class="review-block ">
                        <div class="grid grid-cols-3 p-5">
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="mt-3">
                                    @auth
                                        @if (Auth::user()->alreadyLiked($review->id))
                                            <button id="like" type="button" data-id="{{$review->id}}" class="border rounded p-1 text-xs like">
                                                <i class="fa fa-thumbs-down"></i> <small>إلغاء الاعجاب</small>
    ...
    $(function(){
        $('button.like').on('click', function() {
            ...
            $.ajax({
                ...
                if(data){
                    $trim(likebtn.find('small').text(data)) == 'أعجبني' ? showUnLike(data) : showLike(data); 
                }
                else{
